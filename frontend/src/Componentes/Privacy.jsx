    ...
    <section className="relative min-h-screen bg-[url('/img/solar-panels.jpg')] bg-cover bg-center flex items-center justify-center px-4 sm:px-6 py-17 sm:py-10">
      <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-xl w-full max-w-4xl p-6 sm:p-8 md:p-10 text-white">
        ...
        <p className="mb-4 text-sm sm:text-base leading-relaxed">
          ...
          respetamos tu privacidad y protegemos tus datos personales. Al usar
          nuestra plataforma, aceptas las prácticas descritas en esta Política
          de Privacidad.
        </p>
        ...
        <div className="space-y-6 text-sm sm:text-base leading-relaxed">
          ...
          <div>
            ...
            <p>
              Recopilamos información que proporcionas al registrarte o realizar
              una compra, incluyendo nombre, correo electrónico y datos de
              contacto. También recolectamos información técnica como dirección
              IP, dispositivo, navegador y cookies para mejorar tu experiencia
              en la plataforma.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 mt-2">
              ...
              <li>
                Comunicarnos contigo respecto a tu cuenta o transacciones.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              , así como solicitar la eliminación de tus datos en cualquier
              momento. Para hacerlo, escríbenos a nuestro correo de soporte
              oficial.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Usamos cookies para recordar tu sesión, analizar el uso de la
              plataforma y mejorar la seguridad. Puedes desactivarlas en la
              configuración de tu navegador, aunque esto puede limitar algunas
              funcionalidades.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              los fines descritos en esta política y de acuerdo con la normativa
              aplicable. Una vez cumplido dicho plazo, los eliminaremos de forma
              segura.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              físicas para proteger tu información contra accesos no
          ...
          <div>
            ...
            <p>
              ...
              momento. Las modificaciones se publicarán en esta página y
          ...
          <div>
            ...
            <p>
              Si tienes dudas sobre cómo usamos tu información, contáctanos en
              nuestro{" "}
