            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  >
                    <FaCreditCard className={`w-8 h-8 mx-auto mb-2 ${
                      metodo === "tarjeta" ? "text-[#3dc692]" : "text-white"
                    }`} />
                  ...
                  >
                    <FaUniversity className={`w-8 h-8 mx-auto mb-2 ${
                      metodo === "transferencia" ? "text-[#3dc692]" : "text-white"
                    }`} />
                  ...
                  >
                    <FaMoneyBillWave className={`w-8 h-8 mx-auto mb-2 ${
                      metodo === "entrega" ? "text-[#3dc692]" : "text-white"
                    }`} />
                    ...
                    <div className="space-y-4">
                      <div className="bg-white/5 border border-white/20 rounded-xl p-4">
                        ...
                        <div className="space-y-2 text-white">
                          ...
                          <div className="flex justify-between">
                            <span className="text-blue-200">Cuenta:</span>
                            <span className="font-semibold">123-456789-01</span>
                          </div>
                          <div className="flex justify-between">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-semibold">EcoEnergix S.A.S.</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-xl text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-[#3dc692] file:text-white hover:file:bg-[#5f54b3] transition"
                        />
                      </div>
                    </div>
                  )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 sticky top-24">
              ...
              <div className="space-y-3 border-t border-white/20 pt-4">
                ...
                <div className="flex justify-between text-blue-200">
                  <span>Envío</span>
                  <span className={`font-semibold ${costoEnvio === 0 ? 'text-[#3dc692]' : 'text-white'}`}>
              ...
              <div className="mt-6 space-y-2">
                <div className="flex items-center gap-2 text-sm text-blue-200">
                  <FaLock className="w-4 h-4 text-[#3dc692]" />
                  Pago 100% seguro
                </div>
                <div className="flex items-center gap-2 text-sm text-blue-200">
                  <FaCheckCircle className="w-4 h-4 text-[#3dc692]" />
